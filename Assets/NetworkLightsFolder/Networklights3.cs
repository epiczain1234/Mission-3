...
public class Networklights3 : MonoBehaviour, IPunObservable
{
    // Start is called before the first frame update
    private PhotonView photonView;
    private PhotonView correlatedView;
    void Start(){
      photonView = GameObject.Find("Sphere3").GetComponent<PhotonView>();
       correlatedView = GameObject.Find("Sphere3c").GetComponent<PhotonView>();
    }
    ...
    public void turnSphereRed(){
          Debug.Log("attempting to grab a sphere3 and chance it color");
